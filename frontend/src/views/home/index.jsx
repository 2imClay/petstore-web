...
import pet from '../../assets/images/hero-banner.jpg';
        ...
        <article>
            ...
            <div className="container">
                ...
                <li className="scrollbar-item">
                    ...
                    >
                        <img
                        src="../static/assets/images/category-4.jpg"
                        width="330"
                        height="300"
                        loading="lazy"
                        alt="Dog Toys"
            ...
            <div className="container">
                ...
                <li>
                    ...
                    >
                        <img
                        src="../static/assets/images/product-1.jpg"
                        width="360"
                        height="360"
                        loading="lazy"
                        ...
                        />
                        <img
                        src="../static/assets/images/product-1_0.jpg"
                        width="360"
                        height="360"
                        loading="lazy"
                        alt="Commodo leo sed porta"
            ...
            <div className="container">
                ...
                <img
                src="../static/assets/images/service-image.png"
                width="122"
                height="136"
                loading="lazy"
                alt=""
                ...
                <li>
                    ...
                    <figure className="card-icon">
                        <img
                        src="../static/assets/images/service-icon-1.png"
                        width="70"
                        height="70"
                        loading="lazy"
                        alt="service icon"
                ...
                <li>
                    ...
                    <figure className="card-icon">
                        <img
                        src="../static/assets/images/service-icon-2.png"
                        width="70"
                        height="70"
                        loading="lazy"
                        alt="service icon"
                ...
                <li>
                    ...
                    <figure className="card-icon">
                        <img
                        src="../static/assets/images/service-icon-3.png"
                        width="70"
                        height="70"
                        loading="lazy"
                        alt="service icon"
                ...
                <li>
                    ...
                    <figure className="card-icon">
                        <img
                        src="../static/assets/images/service-icon-4.png"
                        width="70"
                        height="70"
                        loading="lazy"
                        alt="service icon"
            ...
            aria-label="cta"
            style={{ backgroundImage: "url('../static/assets/images/cta-bg.jpg')" }}
            >
            <div className="container">

                <figure className="cta-banner">
                <img
                    src="../static/assets/images/cta-banner.png"
                    width="900"
                    height="660"
                    loading="lazy"
                    alt="cat"
